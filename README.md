...
This repository contains the implementation of the graph neural networks implemented for the Final Year Project (FYP). This was originally forked from [JamesChuanggg/ggnn.pytorch](https://github.com/JamesChuanggg/ggnn.pytorch) and modified to include the Residual Gated Graph ConvNet model [here](https://github.com/xbresson/spatial_graph_convnets).
